...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            ...
            if isinstance(entity, (IndegoMapCamera, IndegoProgressCamera))
        ]
    )

class IndegoMapCamera(IndegoEntity, Camera):
...
class IndegoProgressCamera(IndegoMapCamera):
    def __init__(self, entity_id, name, device_info: DeviceInfo, indego_hub):
        super().__init__(entity_id, name, device_info, indego_hub)
